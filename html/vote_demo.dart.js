...
$$.VoteDemo = {"":
 ...
 VoteDemo$_internal$8: function(_canvas, _stage, _dragger, _rootMapElement, _condorcetView, _pluralityView, _distanceView, _canManView) {
  ...
  $.add$1(this._rootMapElement.get$candidatesMoved(), new $.anon3(this));
  $.add$1(this._stage.get$invalidated(), new $.anon4(this));
  var t4 = this._canManView;
  $.add$1(t4.get$candidateRemoveRequest(), new $.anon5(this));
  $.add$1(t4.get$newCandidateRequest(), new $.anon6(this));
  $.add$1(this._condorcetView.get$hoverChanged(), new $.anon7(this));
...
$$._Timer = {"":
 ...
 cancel$0: function() {
  if (this._once === true)
    $._window().clearTimeout$1(this._handle);
  else
    $._window().clearInterval$1(this._handle);
},
...
$$.Grouping = {"":
 ...
 Grouping$2: function(source, keyFunc) {
  ...
  for (var t1 = $.iterator(source), t2 = this._lib1_values; t1.hasNext$0() === true;) {
    var t3 = t1.next$0();
    $.add$1(t2.putIfAbsent$2(keyFunc.call$1(t3), new $.anon1()), t3);
  }
}
};
...
$$.Stage = {"":
 ...
 draw$0: function() {
  ...
  return this._lib4_element.draw$1(this._ctx);
},
 childInvalidated$1: function(child) {
  this.validateNotDisposed$0();
  this._invalidatedEventHandle.fireEvent$1($.CTC24);
...
$$.RootMapElement = {"":
 ...
 dragCandidate$2: function(candidate, delta) {
  ...
  this._candidatesMovedHandle.fireEvent$1($.CTC24);
},
 update$0: function() {
  var t1 = this._bounds;
...
$$.VoterMapElement = {"":
 ["_players", "_tx?", "_radius=", "_lib6_map", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib4_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "PElement",
 ...
 _drawPlayer$2$bailout: function(state, env0, env1, env2, env3, env4) {
  switch (state) {
    case 1:
      var ctx = env0;
      var player = env1;
...
$$.CandidateMapElement = {"":
 ["_players", "_tx?", "_radius=", "_lib6_elements", "_showOnlyPlayers", "_transforms", "cacheEnabled", "_updatedEventHandle", "_invalidatedEventHandle", "_cacheCanvas", "_width", "_height", "_alpha", "_lastDrawSize", "clip", "_lib4_parent", "_propertyValues", "_eventHandlers", "_disposed"],
 "super": "ElementParentImpl",
 get$visualChildCount: function() {
  this._ensureElements$0();
  return $.get$length(this._lib6_elements);
},
 getVisualChild$1: function(index) {
  this._ensureElements$0();
  var t1 = this._lib6_elements;
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
 ...
 getVisualChild$1$bailout: function(state, index, t1) {
  return $.index(t1, index);
},
 setTransform$1: function(value) {
  $.requireArgumentNotNull(value, 'value');
 ...
 _ensureElements$0: function() {
  if (this._lib6_elements == null) {
    this._lib6_elements = $.ListImplementation_List(null);
    for (var t1 = $.iterator(this._players), t2 = this._tx; t1.hasNext$0() === true;) {
      ...
      $.add$1(this._lib6_elements, ce);
    }
    this._updateCandidateElements$0();
  }
},
 _updateCandidateElements$0: function() {
  for (var t1 = $.iterator(this._lib6_elements); t1.hasNext$0() === true;) {
    var t2 = t1.next$0();
...
$$.CandidateManagerView = {"":
 ...
 _requestNewCandidate$1: function(args) {
  ...
  this._requestNewCandidateHandle.fireEvent$1($.CTC24);
...
$$.CondorcetView = {"":
 ...
 get$hoveringPair: function() {
  return this._hoveringPair;
},
 updateElement$0: function() {
  $.clear(this.get$node().get$elements());
  var table = $.TableElement_TableElement();
  ...
  if (!(t1 == null)) {
    ...
    var colors = this._candidates.toHashMap$1(new $.CondorcetView_updateElement_anon0());
    if (typeof colors !== 'string' && (typeof colors !== 'object' || colors === null || colors.constructor !== Array && !colors.is$JavaScriptIndexingBehavior()))
      return this.updateElement$0$bailout(1, colors, cell, row, table, 0);
    var darkColors = this._candidates.toHashMap$1(new $.CondorcetView_updateElement_anon1());
    if (typeof darkColors !== 'string' && (typeof darkColors !== 'object' || darkColors === null || darkColors.constructor !== Array && !darkColors.is$JavaScriptIndexingBehavior()))
      return this.updateElement$0$bailout(2, colors, cell, row, darkColors, table);
      ...
      for (var t3 = $.iterator(t2), first = true; t3.hasNext$0() === true;) {
        ...
        for (t5 = $.iterator(this._candidates); t5.hasNext$0() === true;) {
          ...
          if ($.eqB(t6, t4)) {
            ...
            if (t4 === pair.get$winner()) {
              var t7 = darkColors.length;
              if (t4 >= t7)
                throw $.ioore(t4);
              var leftColor = darkColors[t4];
              if (t6 !== (t6 | 0))
                throw $.iae(t6);
              if (t6 < 0 || t6 >= t7)
                throw $.ioore(t6);
              var rightColor = darkColors[t6];
              var middleText = '&gt;';
              ...
              if (t6 < 0 || t6 >= t7)
                throw $.ioore(t6);
              rightColor = colors[t6];
              middleText = '&lt;';
              cellClass = 'loser';
            } else {
              t7 = darkColors.length;
              if (t4 >= t7)
                throw $.ioore(t4);
              leftColor = darkColors[t4];
              if (t6 !== (t6 | 0))
                throw $.iae(t6);
              if (t6 < 0 || t6 >= t7)
                throw $.ioore(t6);
              rightColor = darkColors[t6];
              middleText = '=';
              cellClass = 'tie';
            }
 ...
 updateElement$0$bailout: function(state, env0, env1, env2, env3, env4) {
  switch (state) {
    case 1:
      colors = env0;
      cell = env1;
  ...
  switch (state) {
    case 0:
      ...
      var t1 = this._election;
    default:
      if (state === 2 || state === 1 || state === 0 && !(t1 == null))
        switch (state) {
          case 0:
            this._candidates = t1.get$places().selectMany$1(new $.CondorcetView_updateElement_anon()).toReadOnlyCollection$0();
            var colors = this._candidates.toHashMap$1(new $.CondorcetView_updateElement_anon0());
                ...
                for (t5 = $.iterator(this._candidates); t5.hasNext$0() === true;) {
                  ...
                  if ($.eqB(t6, t4)) {
                    ...
                    if ($.eqB(t4, pair.get$winner())) {
                      var leftColor = $.index(darkColors, t4);
                      var rightColor = $.index(darkColors, t6);
                      var middleText = '&gt;';
                      var cellClass = 'winner';
                    } else if ($.eqB(t6, pair.get$winner())) {
                      leftColor = $.index(colors, t4);
                      rightColor = $.index(colors, t6);
                      middleText = '&lt;';
                      cellClass = 'loser';
                    } else {
                      leftColor = $.index(darkColors, t4);
                      rightColor = $.index(darkColors, t6);
                      middleText = '=';
                      cellClass = 'tie';
                    }
                    var cellData = this._getPairElementName$2(t4, t6);
 ...
 set$_thePair: function(pair) {
  if (!$.eqB(pair, this._hoveringPair)) {
    this._hoveringPair = pair;
    this._updateCellHoverStyle$0();
    this._hoverChangedHandle.fireEvent$1($.CTC24);
  }
},
 _updateCellHoverStyle$0: function() {
  ...
  var t1 = this._hoveringPair;
  if (!(t1 == null)) {
    var matchClass = this._getPairElementName$2(t1.get$item1(), t1.get$item2());
 ...
 _onMouseOver$1: function(e) {
  ...
  if (typeof t1 === 'object' && t1 !== null && t1.is$Element()) {
    ...
    if (!(pair == null)) {
      this.set$_thePair($.Tuple$($.index(this._candidates, pair.get$item1()), $.index(this._candidates, pair.get$item2())));
      return;
    }
  }
...
$$.FutureValue = {"":
 ...
 set$input: function(value) {
  ...
  if (this._future == null)
    ...
    this._pending = true;
  this._inputChangedHandle.fireEvent$1($.CTC24);
},
 get$output: function() {
  return this._output;
},
 ...
 _futureCompleted$1: function(value) {
  this._future = null;
  this._output = value;
  this._outputChangedHandle.fireEvent$1($.CTC24);
  this._cleanup$0();
},
...
$$.anon7 = {"":
 ...
 call$1: function(args) {
  var t1 = this.this_4;
  var t2 = t1.get$_condorcetView().get$hoveringPair();
  t1.get$_calcEngine().set$hoverPair(t2);
  var hoverElements = !(t1.get$_condorcetView().get$hoveringPair() == null) ? [t1.get$_condorcetView().get$hoveringPair().get$item1(), t1.get$_condorcetView().get$hoveringPair().get$item2()] : null;
  t1.get$_rootMapElement().set$showOnlyPlayers(hoverElements);
}
};
...
$$.CondorcetView_updateElement_anon0 = {"":
 ...
 call$1: function(c) {
  ...
  if (hue == null)
    ...
    return $.HslColor_HslColor(hue, 1, 0.75).toRgb$0().toHex$0();
}
};
...
$$.CondorcetView_updateElement_anon1 = {"":
 ...
 call$1: function(c) {
  ...
  if (hue == null)
    ...
    return $.HslColor_HslColor(hue, 1, 0.3).toRgb$0().toHex$0();
}
};
...
$.main = function() {
  $.VoteDemo_VoteDemo($.query('#content'), $.query('#pluralityView'), $.query('#distanceView'), $.query('#condorcetView'), $.query('#canManView'))._requestFrame$0();
};
...
$.VoteDemo_VoteDemo = function(canvas, pluralityDiv, distanceDiv, condorcetDiv, canManDiv) {
  ...
  return $.VoteDemo$_internal(canvas, stage, $.Dragger$(canvas), voterMap, condorcetView, pluralityView, distanceView, canManView);
};
...
$.CTC44 = 'The input sequence contains more than one element.';
$.CTC29 = new Isolate.$isolateProperties.InvalidOperationException('The input sequence contains more than one element.');
$.CTC45 = null;
$.CTC35 = new Isolate.$isolateProperties.NotImplementedException(null);
...
$.CTC49 = '';
$.CTC33 = new Isolate.$isolateProperties.UnsupportedOperationException('');
$.CTC50 = 'Cannot sort immutable List.';
$.CTC22 = new Isolate.$isolateProperties.UnsupportedOperationException('Cannot sort immutable List.');
$.CTC51 = 'frozen class set cannot be modified';
...
$.CTC59 = true;
$.CTC39 = new Isolate.$isolateProperties.ConstantMap(6, {'childList': true, 'attributes': true, 'characterData': true, 'subtree': true, 'attributeOldValue': true, 'characterDataOldValue': true}, Isolate.$isolateProperties.CTC58);
...
$.CTC75 = 'Invalid list length';
$.CTC36 = new Isolate.$isolateProperties.ArgumentError('Invalid list length');
$.CTC76 = new Isolate.$isolateProperties._SimpleClientRect(0, 0, 0, 0);
$.CTC40 = new Isolate.$isolateProperties.EmptyElementRect(Isolate.$isolateProperties.CTC76, Isolate.$isolateProperties.CTC76, Isolate.$isolateProperties.CTC76, Isolate.$isolateProperties.CTC76, Isolate.$isolateProperties.CTC1);
$.CTC25 = new Isolate.$isolateProperties._UndefinedValue();
$.CTC77 = '^\\[name=["\'][^\'"]+[\'"]\\]$';
$.CTC37 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^\\[name=["\'][^\'"]+[\'"]\\]$');
$.CTC32 = new Isolate.$isolateProperties.IllegalAccessException();
$.CTC78 = '^[*a-zA-Z0-9]+$';
$.CTC38 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^[*a-zA-Z0-9]+$');
