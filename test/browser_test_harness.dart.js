...
$$._UnorderedEquals = {"":
 ["_expected"],
 "super": "BaseMatcher",
 _test$1: function(item){if(!(typeof item==='object'&&item!==null&&(item.constructor===Array||item.is$Iterable())))return 'not iterable';var t1=this._expected;var expectedLength=t1.length;if(typeof item==='object'&&item!==null&&(item.constructor===Array||item.is$Collection()))var actualLength=$.get$length(item);else for(var t2=$.iterator(item),actualLength=0;t2.hasNext$0()===true;){t2.next$0();++actualLength;}if(typeof actualLength!=='number')return this._test$1$bailout(1,item,actualLength,expectedLength,t1);if(expectedLength>actualLength)return 'has too few elements ('+$.S(actualLength)+' < '+$.S(expectedLength)+')';else if(expectedLength<actualLength)return 'has too many elements ('+$.S(actualLength)+' > '+$.S(expectedLength)+')';var matched=$.ListImplementation_List(actualLength);for(var i=0;i<actualLength;++i){if(i<0||i>=matched.length)throw $.ioore(i);matched[i]=false;}for(var t1=$.iterator(t1),expectedPosition=0;t1.hasNext$0()===true;){t2=t1.next$0();for(var t3=$.iterator(item),actualPosition=0;gotMatch=false,t3.hasNext$0()===true;){var t4=t3.next$0();if(actualPosition<0||actualPosition>=matched.length)throw $.ioore(actualPosition);if(matched[actualPosition]!==true)if($.eqB(t2,t4)){if(actualPosition<0||actualPosition>=matched.length)throw $.ioore(actualPosition);matched[actualPosition]=true;var gotMatch=true;break;}++actualPosition;}if(!gotMatch){var reason=$.StringDescription$('');$.add$1(reason.add$1('has no match for element ').addDescriptionOf$1(t2),' at position '+$.S(expectedPosition));return reason.toString$0();}++expectedPosition;}return;},
 _test$1$bailout: function(state,item,actualLength,expectedLength,t1){if($.gtB(expectedLength,actualLength))return 'has too few elements ('+$.S(actualLength)+' < '+$.S(expectedLength)+')';else if($.ltB(expectedLength,actualLength))return 'has too many elements ('+$.S(actualLength)+' > '+$.S(expectedLength)+')';var matched=$.ListImplementation_List(actualLength);for(var i=0;$.ltB(i,actualLength);++i){if(i<0||i>=matched.length)throw $.ioore(i);matched[i]=false;}for(var t1=$.iterator(t1),expectedPosition=0;t1.hasNext$0()===true;){var t2=t1.next$0();for(var t3=$.iterator(item),actualPosition=0;gotMatch=false,t3.hasNext$0()===true;){var t4=t3.next$0();if(actualPosition<0||actualPosition>=matched.length)throw $.ioore(actualPosition);if(matched[actualPosition]!==true)if($.eqB(t2,t4)){if(actualPosition<0||actualPosition>=matched.length)throw $.ioore(actualPosition);matched[actualPosition]=true;var gotMatch=true;break;}++actualPosition;}if(!gotMatch){var reason=$.StringDescription$('');$.add$1(reason.add$1('has no match for element ').addDescriptionOf$1(t2),' at position '+$.S(expectedPosition));return reason.toString$0();}++expectedPosition;}return;},
...
$$.TestCase = {"":
 ...
 run$0: function(){if(this.enabled===true){this.stackTrace=null;this.result=null;this.message='';this._doneTeardown=false;if(!(this._setUp==null))this._setUp$0();$._config.onTestStart$1(this);this.startTime=$.Date_Date$now();this.runningTime=null;this.test$0();}},
 _complete$0: function(){if(this.runningTime==null)this.runningTime=$.Duration$(0,0,0,0,0);if(this._doneTeardown!==true){if(!(this._tearDown==null))this._tearDown$0();this._doneTeardown=true;}$._config.onTestResult$1(this);},
...
$$._BufferingSendPort = {"":
 ...
 _BufferingSendPort$2: function(isolateId,_futurePort){$._BufferingSendPort__idCount=$.add($._BufferingSendPort__idCount,1);this._futurePort.then$1(new $.anon1(this));},
...
$$.Enumerable = {"":
 ...
 first$1: function(f){if(f==null)f=new $.Enumerable_first_anon();var iter=$._WhereIterator$(this.iterator$0(),f);if(iter.hasNext$0()!==true)throw $.$$throw($.CTC20);return iter.next$0();},
 first$0: function() {
...
$$.ListBase = {"":
 ...
 addAll$1: function(value){throw $.$$throw($.CTC13);},
 sort$1: function(comparer){throw $.$$throw($.CTC13);},
 clear$0: function(){throw $.$$throw($.CTC13);},
 removeLast$0: function(){throw $.$$throw($.CTC13);},
 removeRange$2: function(start,length$){throw $.$$throw($.CTC13);},
 insertRange$3: function(start,length$,initialValue){throw $.$$throw($.CTC13);},
 is$List: function() { return true; },
 is$Collection: function() { return true; },
 is$Iterable: function() { return true; }
};
...
$$.Grouping = {"":
 ...
 Grouping$2: function(source,keyFunc){if(keyFunc==null)keyFunc=new $.anon();for(var t1=$.iterator(source),t2=this._lib0_values;t1.hasNext$0()===true;){var t3=t1.next$0();$.add$1(t2.putIfAbsent$2(keyFunc.call$1(t3),new $.anon0()),t3);}}
};
...
$$.RgbColor = {"":
 ["r?", "g?", "b?"],
 "super": "Object",
 toHex$0: function(){var buffer=$.StringBuffer_StringBuffer('#');$.forEach([this.r,this.g,this.b],new $.RgbColor_toHex_anon(buffer));return $.toString(buffer);},
...
$$.TarjanCycleDetect = {"":
 ...
 "super": "Object",
 _executeTarjan$0: function(){for(var t1=$.iterator($.ListImplementation_List$from(this._lib0_list.getSourceNodeSet$0()));t1.hasNext$0()===true;){var t2=t1.next$0();if($.eqB(t2.get$index(),-1))this._tarjan$1(t2);}return this._scc;},
 _tarjan$1: function(v){v.set$index(this._lib0_index);v.set$lowlink(this._lib0_index);var t1=this._lib0_index;if(typeof t1!=='number')return this._tarjan$1$bailout(1,v,t1,0,0,0);this._lib0_index=t1+1;var t3=this._stack;$.insertRange$3(t3,0,1,v);for(t1=$.iterator(this._lib0_list.getAdjacent$1(v));t1.hasNext$0()===true;){var t2=t1.next$0();var t4=t2.get$index();if(typeof t4!=='number')return this._tarjan$1$bailout(2,v,t4,t3,t1,t2);if(t4===-1){this._tarjan$1(t2);v.set$lowlink($.min(v.get$lowlink(),t2.get$lowlink()));}else{t4=$.indexOf$1(t3,t2);if(typeof t4!=='number')return this._tarjan$1$bailout(3,v,t4,t3,t1,t2);if(t4>=0)v.set$lowlink($.min(v.get$lowlink(),t2.get$index()));}}if($.eqB(v.get$lowlink(),v.get$index())){var component=$.ListImplementation_List(null);var n=null;do{if(0>=t3.length)throw $.ioore(0);n=t3[0];$.removeRange(t3,0,1);component.push(n.get$value());}while(!$.eqB(n,v));this._scc.push(component);}},
...
$$.LocationData = {"":
 ["candidates?", "voters?"],
 "super": "Object",
 cloneAndRemove$1: function(mp){$.requireArgumentNotNull(mp,'mp');var newCans=$.filter(this.candidates,new $.LocationData_cloneAndRemove_anon(mp)).toReadOnlyCollection$0();return $.LocationData$(this.voters,newCans);},
...
$$.CalcEngine = {"":
 ...
 CalcEngine$0: function(){$.add$1(this._distanceElectionMapper.get$outputChanged(),new $.anon2(this));}
};
...
$$.FutureValue = {"":
 ...
 set$input: function(value){this._input=value;if(this._future==null)this._startFuture$0();else this._pending=true;this._inputChangedHandle.fireEvent$1($.CTC51);},
 ...
 _futureCompleted$1: function(value){this._future=null;this._output=value;this._outputChangedHandle.fireEvent$1($.CTC51);this._cleanup$0();},
...
$$.TestCondorcetPair_run_anon0 = {"":
 ["c1_0"],
 "super": "Closure",
 call$0: function(){$.expect(new $.TestCondorcetPair_run_anon9(this.c1_0),$.CTC32,null,null,false);}
};
...
$$.TestCondorcetPair_run_anon1 = {"":
 ["c1_4", "c2_3", "v1_2"],
 "super": "Closure",
 call$0: function(){var t1=this.v1_2;var t2=this.c1_4;var t3=this.c2_3;var b1=$.RankedBallot_RankedBallot(t1,[t2,t3]);$.expect(new $.TestCondorcetPair_run_anon8(t2,t3,$.RankedBallot_RankedBallot(t1,[t2,t3]),b1),$.CTC32,null,null,false);}
};
...
$$.TestCondorcetPair_run_anon2 = {"":
 ["c1_11", "c2_10", "v1_9"],
 "super": "Closure",
 call$0: function(){var t1=this.v1_9;var t2=this.c1_11;var b1=$.RankedBallot_RankedBallot(t1,[t2]);var t3=this.c2_10;var b2=$.RankedBallot_RankedBallot(t1,[t3]);$.expect(new $.TestCondorcetPair_run_anon6(t2,t3,b1),$.CTC32,null,null,false);$.expect(new $.TestCondorcetPair_run_anon7(t2,t3,b2),$.CTC32,null,null,false);}
};
...
$$.TestRankedBallot_run_anon0 = {"":
 ["c1_0"],
 "super": "Closure",
 call$0: function(){$.expect(new $.TestRankedBallot_run_anon9(this.c1_0),$.CTC32,null,null,false);}
};
...
$$.TestRankedBallot_run_anon1 = {"":
 ["v2_2"],
 "super": "Closure",
 call$0: function(){$.expect(new $.TestRankedBallot_run_anon8(this.v2_2),$.CTC32,null,null,false);}
};
...
$$.TestRankedBallot_run_anon2 = {"":
 ["v2_4"],
 "super": "Closure",
 call$0: function(){$.expect(new $.TestRankedBallot_run_anon7(this.v2_4),$.CTC32,null,null,false);}
};
...
$$.TestRankedBallot_run_anon3 = {"":
 ["c1_7", "v2_6"],
 "super": "Closure",
 call$0: function(){$.expect(new $.TestRankedBallot_run_anon6(this.c1_7,this.v2_6),$.CTC32,null,null,false);}
};
...
$$._Throws_matches_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$1: function(future){if(future.get$hasValue()===true)$.expect(false,$.CTC31,'Expected future to fail, but succeeded with \''+$.S(future.get$value())+'\'.',null,false);else{var t1=this.this_0;if(!(t1.get$_matcher()==null)){var reason=!(future.get$stackTrace()==null)?'Actual exception trace:\n'+('  '+$.S($.replaceAll($.toString(future.get$stackTrace()),'\n','\n  '))):null;$.expect(future.get$exception(),t1.get$_matcher(),reason,null,false);}}}
};
...
$$._TarjanList__TarjanList_anon = {"":
 ["nodes_1", "map_0"],
 "super": "Closure",
 call$2: function(k,v){var t1=this.map_0;var tKey=t1.putIfAbsent$2(k,new $._TarjanList__TarjanList_anon0(k));var t2=this.nodes_1;var edges=$.HashSet_HashSet();$.indexSet(t2,tKey,edges);if(!(v==null))for(t2=$.iterator(v);t2.hasNext$0()===true;){var t3=t2.next$0();$.add$1(edges,t1.putIfAbsent$2(t3,new $._TarjanList__TarjanList_anon1(t3)));}}
};
...
$$._voterHexMapperIsolate_anon = {"":
 [],
 "super": "Closure",
 call$2: function(tuple,reply){var map=$.HashMapImplementation$();for(var t1=$.iterator(tuple.get$Item1().get$ballots());t1.hasNext$0()===true;){var t2=t1.next$0();var candidate=tuple.get$Item3()==null?t2.get$choice():$.filter(t2.get$rank(),new $._voterHexMapperIsolate_anon0(tuple)).first$0();if(!(candidate==null)){var hue=$.LocationData_getHue(candidate);map.operator$indexSet$2(t2.get$voter(),$.HslColor_HslColor(hue,0.5,0.75).toRgb$0().toHex$0());}}reply.send$1(map);}
};
...
$.TestLocationData__testCloneAndAddRemoveCandidate = function(){var data=$.LocationData_LocationData$random();$.expect(data.get$candidates(),$.hasLength(5),null,null,false);$.expect($.map($.$$(data.get$candidates()),new $.TestLocationData__testCloneAndAddRemoveCandidate_anon()),$.orderedEquals(['A','B','C','D','E']),null,null,false);var canC=$.index(data.get$candidates(),2);$.expect(canC.get$name(),$.equals('C',100),null,null,false);data=data.cloneAndRemove$1(canC);$.expect(data.get$candidates(),$.hasLength(4),null,null,false);$.expect($.map($.$$(data.get$candidates()),new $.TestLocationData__testCloneAndAddRemoveCandidate_anon0()),$.orderedEquals(['A','B','D','E']),null,null,false);data=data.cloneAndAddCandidate$0();$.expect(data.get$candidates(),$.hasLength(5),null,null,false);$.expect($.map($.$$(data.get$candidates()),new $.TestLocationData__testCloneAndAddRemoveCandidate_anon1()),$.orderedEquals(['A','B','C','D','E']),null,null,false);data=data.cloneAndAddCandidate$0();$.expect(data.get$candidates(),$.hasLength(6),null,null,false);$.expect($.map($.$$(data.get$candidates()),new $.TestLocationData__testCloneAndAddRemoveCandidate_anon2()),$.orderedEquals(['A','B','C','D','E','F']),null,null,false);};
...
$.main = function(){$.groupSep=' - ';$.useHtmlEnhancedConfiguration(false);$.runVoteTests();$.runMapTests();$.runCalcTests();};
...
$.TestCondorcetElection__sample2 = function(){var ballots=$.ListImplementation_List(null);for(var voter=1,i=0;i<29;++i){var voter0=voter+1;ballots.push($.RankedBallot_RankedBallot('Voter '+$.S(voter),['Chocolate Chunk','Chocolate','Vanilla']));voter=voter0;}for(i=0;i<31;++i){voter0=voter+1;ballots.push($.RankedBallot_RankedBallot('Voter '+$.S(voter),['Chocolate','Chocolate Chunk','Vanilla']));voter=voter0;}for(i=0;i<40;++i){voter0=voter+1;ballots.push($.RankedBallot_RankedBallot('Voter '+$.S(voter),['Vanilla','Chocolate','Chocolate Chunk']));voter=voter0;}var ce=$.CondorcetElection_CondorcetElection(ballots);$.expect(ce,$.CTC36,null,null,false);$.expect(ce.get$singleWinner(),$.equals('Chocolate',100),null,null,false);$.expect(ce.get$candidates(),$.unorderedEquals(['Chocolate','Chocolate Chunk','Vanilla']),null,null,false);$.expect(ce.get$ballots(),$.unorderedEquals(ballots),null,null,false);$.expect($.get$length(ce.get$places()),$.equals(3,100),null,null,false);$.expect($.index(ce.get$places(),0).get$place(),$.equals(1,100),null,null,false);$.expect($.index(ce.get$places(),0),$.unorderedEquals(['Chocolate']),null,null,false);$.expect($.index(ce.get$places(),1).get$place(),$.equals(2,100),null,null,false);$.expect($.index(ce.get$places(),1),$.unorderedEquals(['Chocolate Chunk']),null,null,false);$.expect($.index(ce.get$places(),2).get$place(),$.equals(3,100),null,null,false);$.expect($.index(ce.get$places(),2),$.unorderedEquals(['Vanilla']),null,null,false);};
...
$.TestLocationData__testGetCandidateName = function(){$.expect($.LocationData_getCandidateName(0),$.equals('A',100),null,null,false);$.expect($.LocationData_getCandidateName(1),$.equals('B',100),null,null,false);$.expect($.LocationData_getCandidateName(25),$.equals('Z',100),null,null,false);$.expect(new $.TestLocationData__testGetCandidateName_anon(),$.CTC32,null,null,false);};
...
$.TestSpoilerMap_run = function(){var voters=$.ListImplementation_List(null);for(var i=0;i<=10;++i)voters.push($.MapPlayer$($.Coordinate$(i,0),null));var canCenter=$.MapPlayer$($.CTC37,null);var canLeft=$.MapPlayer$($.CTC38,null);var canSpoiler=$.MapPlayer$($.CTC39,null);$.group('spoiler',new $.TestSpoilerMap_run_anon(canCenter,$.DistanceElection_DistanceElection(voters,[canCenter,canLeft,canSpoiler]).get$ballots(),canSpoiler,canLeft));};
...
$.HashSet_HashSet = function(){return $.HashSetImplementation$();};
...
$.Uri$fromString = function(uri){var t1=$.CTC50.firstMatch$1(uri);return new $.Uri($.Uri__emptyIfNull($.index(t1,1)),$.Uri__emptyIfNull($.index(t1,2)),$.Uri__emptyIfNull($.index(t1,3)),$.Uri__parseIntOrZero($.index(t1,4)),$.Uri__emptyIfNull($.index(t1,5)),$.Uri__emptyIfNull($.index(t1,6)),$.Uri__emptyIfNull($.index(t1,7)));};
...
$.RankedBallot_RankedBallot = function(voter,rank){$.requireArgumentNotNull(voter,'voter');$.requireArgumentNotNull(rank,'rank');var items=$.ReadOnlyCollection$(rank);$.requireArgument($.gt($.get$length(items),0),'rank',null);$.requireArgument($.CollectionUtil_allUnique(items),'rank',null);return $.RankedBallot$protected(voter,items);};
...
$.CondorcetElection_CondorcetElection = function(ballots){var roBallots=$.$$(ballots).toReadOnlyCollection$0();$.requireArgument($.CollectionUtil_allUnique($.map(roBallots,new $.CondorcetElection_CondorcetElection_anon()).toReadOnlyCollection$0()),'Only one ballot per voter is allowed',null);var hashMap=$.HashMapImplementation$();var candidateHashSet=$.HashSet_HashSet();for(var t1=$.iterator(ballots);t1.hasNext$0()===true;){var t2=t1.next$0();for(var i=0;$.ltB(i,$.get$length(t2.get$rank()));++i){var candidateI=$.index(t2.get$rank(),i);$.add$1(candidateHashSet,candidateI);for(var j=i+1;$.ltB(j,$.get$length(t2.get$rank()));++j)$.add$1(hashMap.putIfAbsent$2($.CondorcetPair_CondorcetPair(candidateI,$.index(t2.get$rank(),j),null),new $.CondorcetElection_CondorcetElection_anon0()),t2);}}var hashSet=$.HashSet_HashSet();hashMap.forEach$1(new $.CondorcetElection_CondorcetElection_anon1(hashSet));var candidateProfiles=$.HashMapImplementation$();var tarjanMap=$.HashMapImplementation$();for(t1=$.iterator(candidateHashSet);t1.hasNext$0()===true;){t2=t1.next$0();var lostTo=$.ListImplementation_List(null);var beat=$.ListImplementation_List(null);var tied=$.ListImplementation_List(null);var tarjanLostTiedSet=$.HashSet_HashSet();for(var t3=$.iterator(hashSet);t3.hasNext$0()===true;){var t4=t3.next$0();if($.eqB(t4.get$Item1(),t2)||$.eqB(t4.get$Item2(),t2)){var other=$.eqB(t4.get$Item1(),t2)?t4.get$Item2():t4.get$Item1();if(t4.get$isTie()===true){tied.push(other);$.add$1(tarjanLostTiedSet,other);}else if($.eqB(t4.get$winner(),t2))beat.push(other);else{lostTo.push(other);$.add$1(tarjanLostTiedSet,other);}}}candidateProfiles.operator$indexSet$2(t2,$.CondorcetCandidateProfile$_internal(t2,$.ReadOnlyCollection$(lostTo),$.ReadOnlyCollection$(beat),$.ReadOnlyCollection$(tied)));tarjanMap.operator$indexSet$2(t2,tarjanLostTiedSet);}var components=$.TarjanCycleDetect_getStronglyConnectedComponents(tarjanMap);var places=$.ListImplementation_List(null);for(var t1=$.iterator(components),placeNumber=1;t1.hasNext$0()===true;){t2=t1.next$0();places.push($.ElectionPlace$(placeNumber,t2));t2=$.get$length(t2);if(typeof t2!=='number')throw $.iae(t2);placeNumber+=t2;}return $.CondorcetElection$_internal(hashSet,candidateProfiles,roBallots,$.ReadOnlyCollection$(places));};
...
$.DistanceElection_DistanceElection = function(voters,candidates){var t1={};var cans=$.ReadOnlyCollection$(candidates);var ballots=$.map($.$$(voters),new $.DistanceElection_DistanceElection_anon(cans)).toReadOnlyCollection$0();var distanceGroups=$.$$(cans).group$1(new $.DistanceElection_DistanceElection_anon0(ballots));var distances=$.ListImplementation_List$from(distanceGroups.getKeys$0());$.sort(distances,new $.DistanceElection_DistanceElection_anon1());t1.placeNumber_1=1;return $.DistanceElection$_internal(cans,ballots,$.map($.$$(distances),new $.DistanceElection_DistanceElection_anon2(t1,distanceGroups)).toReadOnlyCollection$0());};
...
$.TestPlurality_randomVoteTest = function(){var voters=$.ListImplementation_List(null);for(var i=0;i<10;++i)voters.push('Voter '+$.S(i));$.PluralityElection_PluralityElection($.map(voters,new $.TestPlurality_randomVoteTest_anon('candidate 1')));};

$.Completer_Completer = function(){return $.CompleterImpl$();};

$.RankedBallot$protected = function(voter,items){return new $.RankedBallot(items,items.operator$index$1(0),voter);};
...
$.toRadixString = function(receiver,radix){if(!(typeof receiver==='number'))return receiver.toRadixString$1(radix);$.checkNum(radix);if(radix<2||radix>36)throw $.$$throw($.IllegalArgumentException$(radix));return receiver.toString(radix);};
...
$.PluralityBallot$ = function(voter,choice){return new $.PluralityBallot(choice,voter);};
...
$.CTC56 = 9;
$.CTC47 = new Isolate.$isolateProperties.Coordinate(9, 9);
...
$.CTC60 = false;
$.CTC61 = '^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([\\w\\d\\-\\u0100-\\uffff.%]*)(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$';
$.CTC50 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([\\w\\d\\-\\u0100-\\uffff.%]*)(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$');
$.CTC46 = new Isolate.$isolateProperties.Coordinate(1, -1);
$.CTC62 = 'TODO(jacobr): should we impl?';
...
$.CTC65 = 'IllegalArgumentException';
$.CTC66 = new Isolate.$isolateProperties._IllegalArgumentException('IllegalArgumentException');
$.CTC32 = new Isolate.$isolateProperties._Throws(Isolate.$isolateProperties.CTC66);
$.CTC67 = 10;
$.CTC49 = new Isolate.$isolateProperties.Coordinate(10, 10);
$.CTC23 = new Isolate.$isolateProperties.IllegalAccessException();
$.CTC68 = '^[*a-zA-Z0-9]+$';
$.CTC29 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^[*a-zA-Z0-9]+$');
...
$.CTC71 = 'Cannot removeLast on immutable List.';
...
$.CTC86 = 'thead';
$.CTC87 = 'track';
$.CTC88 = Isolate.makeConstantList(['body', 'head', 'caption', 'td', 'colgroup', 'col', 'tr', 'tbody', 'tfoot', 'thead', 'track']);
$.CTC89 = 'IDBKey containing Date';
...
$.CTC91 = 'table';
$.CTC92 = 'audio';
$.CTC22 = new Isolate.$isolateProperties.ConstantMap(11, {'body': 'html', 'head': 'html', 'caption': 'table', 'td': 'tr', 'colgroup': 'table', 'col': 'colgroup', 'tr': 'tbody', 'tbody': 'table', 'tfoot': 'table', 'thead': 'table', 'track': 'audio'}, Isolate.$isolateProperties.CTC88);
$.CTC93 = 'structured clone of Blob';
...
$.CTC96 = 'structured clone of RegExp';
...
$.CTC97 = 'structured clone of FileList';
$.CTC6 = new Isolate.$isolateProperties.NotImplementedException('structured clone of FileList');
$.CTC98 = '^\\[name=["\'][^\'"]+[\'"]\\]$';
$.CTC28 = new Isolate.$isolateProperties.JSSyntaxRegExp(false, false, '^\\[name=["\'][^\'"]+[\'"]\\]$');
$.CTC99 = 4;
$.CTC38 = new Isolate.$isolateProperties.Coordinate(4, 0);
$.CTC100 = 5;
$.CTC37 = new Isolate.$isolateProperties.Coordinate(5, 0);
$.CTC51 = new Isolate.$isolateProperties.EventArgs();
$.CTC101 = 7;
$.CTC39 = new Isolate.$isolateProperties.Coordinate(7, 0);
...
$.CTC102 = 'Mutation operations are not supported';
$.CTC13 = new Isolate.$isolateProperties.UnsupportedOperationException('Mutation operations are not supported');
...
$.isIllegalArgumentException = Isolate.$isolateProperties.CTC66;
$._PASS = 'pass';
$.throwsIllegalArgumentException = Isolate.$isolateProperties.CTC32;
$.groupSep = ' ';
$._ERROR = 'error';
...
$.isTrue = Isolate.$isolateProperties.CTC31;
...
$.$defineNativeClass('CSSRuleList', ["length?"], {
 ...
 isEmpty$0: function(){return $.eq($.get$length(this),0);},
 sort$1: function(compare){throw $.$$throw($.CTC14);},
 indexOf$2: function(element,start){return $._Lists_indexOf(this,element,start,$.get$length(this));},
 indexOf$1: function(element) {
  return this.indexOf$2(element,0)
},
...
$.$defineNativeClass('DocumentFragment', [], {
 ...
 get$attributes: function(){return $.CTC30;},
 click$0: function(){},
...
(function(){
  ...
  var v16/*class(_Uint8ArrayImpl)*/ = 'Uint8Array|Uint8ClampedArray|Uint8ClampedArray';
  var table = [
    ...
    ['Uint8Array', v16/*class(_Uint8ArrayImpl)*/],
    ['ArrayBufferView', [v16/*class(_Uint8ArrayImpl)*/,v16/*class(_Uint8ArrayImpl)*/,'ArrayBufferView|Uint32Array|Uint16Array|Int8Array|Int32Array|Int16Array|Float64Array|Float32Array|DataView|Uint32Array|Uint16Array|Int8Array|Int32Array|Int16Array|Float64Array|Float32Array|DataView'].join('|')],
