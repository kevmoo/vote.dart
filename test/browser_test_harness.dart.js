...
$$._JsSerializer = {"":"_Serializer;_nextFreeRefId,_visited",
 ...
 visitNativeJsSendPort$1: function(port) {
  return ["sendport", $._globalState().get$currentManagerId(), port._isolateId, port._liblib2$_receivePort.get$_id()];
},
...
$$.FilteredElementList = {"":"Object;_node,_childNodes",
 ...
 operator$index$1: function(index) {
  var t1 = this.get$_filtered();
  if (typeof t1 !== 'string' && (typeof t1 !== 'object' || t1 === null || t1.constructor !== Array && !t1.is$JavaScriptIndexingBehavior()))
    return this.operator$index$1$bailout6(1, index, t1);
  if (index !== (index | 0))
    throw $.iae(index);
  if (index < 0 || index >= t1.length)
    throw $.ioore(index);
 ...
 operator$index$1$bailout6: function(state0, index, t1) {
  return $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, index);
},
 iterator$0: function() {
  var t1 = this.get$_filtered();
...
$$.IrvElimination = {"":"Object;candidate>,_transfers,exhausted",
 ...
 getTransferCount$1: function(key) {
  var t1, list;
  t1 = this._transfers;
  list = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, key);
  if (list == null)
    return 0;
  else
...
$$.TestCondorcetPair_run__anon0 = {"":"Closure;c1_2,c2_3,v1_4",
 call$0: function() {
  ...
  t2 = this.c1_2;
  t3 = this.c2_3;
  $.expect(new $.TestCondorcetPair_run___anon1(t2, t3, $.RankedBallot_RankedBallot(t1, [t2, t3]), $.RankedBallot_RankedBallot(t1, [t2, t3])), $.CONSTANT8, null, null, false);
},
 is$Function: true
};
...
$$.TestCondorcetPair_run__anon1 = {"":"Closure;c1_9,c2_10,v1_11",
 call$0: function() {
  ...
  $.expect(new $.TestCondorcetPair_run___anon0(t2, t3, b2), $.CONSTANT8, null, null, false);
},
 is$Function: true
};
      ...
      for (i = 0; i < length$; ++i) {
        ...
        if (!(elementCopy == null ? element == null : elementCopy === element)) {
          ...
          if (typeof copy0 !== 'object' || copy0 === null || (copy0.constructor !== Array || !!copy0.immutable$list) && !copy0.is$JavaScriptIndexingBehavior())
            return this.call$1$bailout1(3, e, t3, elementCopy, $.CONSTANT1, length$, copy0, slot, t2, i, copy);
...
$$.TestSpoilerMap_run__anon = {"":"Closure;",
 call$0: function() {
  var test, election, t1, t2, t3, t4, t5, t6, t7, t8;
  test = $.TestSpoilerMap$();
  ...
  t4 = election.get$places();
  t4 = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0);
  $.expect($.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0), $.equals(t2, 100), null, null, false);
  t5 = election.get$places();
  t5 = $.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, 1);
  $.expect($.getInterceptor$JSStringJSArray(t5).get$length(t5), $.equals(1, 100), null, null, false);
  t6 = election.get$places();
  t6 = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 1);
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 0), $.equals(test.canSpoiler, 100), null, null, false);
  t7 = election.get$places();
  t7 = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, 2);
  $.expect($.getInterceptor$JSStringJSArray(t7).get$length(t7), $.equals(1, 100), null, null, false);
  t8 = election.get$places();
  t8 = $.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, 2);
  $.expect($.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, 0), $.equals(test.canCenter, 100), null, null, false);
},
 is$Function: true
};
...
$$.TestSpoilerMap_run__anon0 = {"":"Closure;",
 call$0: function() {
  ...
  t6 = election.get$places();
  t6 = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 1);
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 0), $.equals(test.canLeft, 100), null, null, false);
  t7 = election.get$places();
  t7 = $.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, 2);
  $.expect($.getInterceptor$JSStringJSArray(t7).get$length(t7), $.equals(1, 100), null, null, false);
  t8 = election.get$places();
  t8 = $.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, 2);
  $.expect($.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, 0), $.equals(test.canSpoiler, 100), null, null, false);
},
 is$Function: true
};
...
$$.TestDistanceElection__testSimpleElection__anon = {"":"Closure;c0_4,c1_5,ballots_6",
 call$0: function() {
  ...
  t2 = $.getInterceptor$JSStringJSArray(t1);
  $.expect(t2.get$length(t1), $.equals(5, 100), null, null, false);
  for (t3 = $.getInterceptor$JSArray(t1).getRange$2(t1, 0, 4), t3 = $.getInterceptor$JSArray(t3).iterator$0(t3), t4 = this.c0_4, t5 = this.c1_5; t3.get$hasNext() === true;) {
    t6 = t3.next$0();
    $.expect(t6.get$choice(), $.equals(t4, 100), null, null, false);
    t7 = t6.get$rank();
    $.expect($.getInterceptor$JSStringJSArray(t7).get$length(t7), $.equals(2, 100), null, null, false);
    t8 = t6.get$rank();
    $.expect($.getInterceptor$JSStringJSArray(t8).operator$index$1(t8, 0), $.equals(t4, 100), null, null, false);
    t6 = t6.get$rank();
    $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 1), $.equals(t5, 100), null, null, false);
  }
  $.expect(t2.operator$index$1(t1, 4).get$choice(), $.equals(t5, 100), null, null, false);
  t3 = t2.operator$index$1(t1, 4).get$rank();
  $.expect($.getInterceptor$JSStringJSArray(t3).get$length(t3), $.equals(2, 100), null, null, false);
  t6 = t2.operator$index$1(t1, 4).get$rank();
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 0), $.equals(t5, 100), null, null, false);
  t7 = t2.operator$index$1(t1, 4).get$rank();
  $.expect($.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, 1), $.equals(t4, 100), null, null, false);
},
 is$Function: true
};
...
$$.TestDistanceElection__testSimpleElection__anon1 = {"":"Closure;c0_9,c1_10,ballots_11",
 call$0: function() {
  var pluralityElection, t1, t2, t3, t4, t5, t6;
  ...
  t3 = pluralityElection.get$places();
  t3 = $.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, 0);
  $.expect($.getInterceptor$JSStringJSArray(t3).get$length(t3), $.equals(1, 100), null, null, false);
  t4 = pluralityElection.get$places();
  t4 = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0);
  $.expect($.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0), $.equals(t2, 100), null, null, false);
  t5 = pluralityElection.get$places();
  t5 = $.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, 1);
  $.expect($.getInterceptor$JSStringJSArray(t5).get$length(t5), $.equals(1, 100), null, null, false);
  t6 = pluralityElection.get$places();
  t6 = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 1);
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 0), $.equals(this.c1_10, 100), null, null, false);
},
 is$Function: true
};
...
$$.TestDistanceElection__testSimpleElection__anon2 = {"":"Closure;c0_12,c1_13,ballots_14",
 call$0: function() {
  var condorcetElection, t1, t2, t3, t4, t5, t6;
  ...
  $.expect($.getInterceptor$JSStringJSArray(t1).get$length(t1), $.equals(2, 100), null, null, false);
  t3 = condorcetElection.get$places();
  t3 = $.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, 0);
  $.expect($.getInterceptor$JSStringJSArray(t3).get$length(t3), $.equals(1, 100), null, null, false);
  t4 = condorcetElection.get$places();
  t4 = $.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0);
  $.expect($.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 0), $.equals(t2, 100), null, null, false);
  t5 = condorcetElection.get$places();
  t5 = $.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, 1);
  $.expect($.getInterceptor$JSStringJSArray(t5).get$length(t5), $.equals(1, 100), null, null, false);
  t6 = condorcetElection.get$places();
  t6 = $.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 1);
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 0), $.equals(this.c1_13, 100), null, null, false);
},
 is$Function: true
};
...
$.TestDistanceElection__testTie = function() {
  var voters, i, j, c0, c1, mapElection, t1, t2, t3;
  voters = $.List_List(null);
  for (i = -2; i <= 2; ++i)
    for (j = -2; j <= 2; ++j)
  ...
  t3 = mapElection.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, 0), $.unorderedEquals([c0, c1]), null, null, false);
};
...
$.TestLocationData__testCloneAndAddRemoveCandidate = function() {
  ...
  canC = $.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, 2);
...
$.TestCondorcetElection__sample1 = function() {
  ...
  $.expect($.getInterceptor$JSStringJSArray(t1).get$length(t1), $.equals(1, 100), null, null, false);
  t2 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, 0), $.unorderedEquals(["Candidate 1"]), null, null, false);
};

$.TestCondorcetElection__sample2 = function() {
  var ballots, voter, i, voter0, ce, t1, t2, t3, t4, t5, t6, t7;
  ...
  $.expect($.getInterceptor$JSStringJSArray(t1).get$length(t1), $.equals(3, 100), null, null, false);
  t2 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, 0).get$place(), $.equals(1, 100), null, null, false);
  t3 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t3).operator$index$1(t3, 0), $.unorderedEquals(["Chocolate"]), null, null, false);
  t4 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t4).operator$index$1(t4, 1).get$place(), $.equals(2, 100), null, null, false);
  t5 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t5).operator$index$1(t5, 1), $.unorderedEquals(["Chocolate Chunk"]), null, null, false);
  t6 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t6).operator$index$1(t6, 2).get$place(), $.equals(3, 100), null, null, false);
  t7 = ce.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t7).operator$index$1(t7, 2), $.unorderedEquals(["Vanilla"]), null, null, false);
};
...
$.TestIrv__testNoTransfersBetweenEliminated = function() {
  var ballots, voter, i, voter0, elec, t1, t2, firstRound, elimC, elimD;
  ballots = $.List_List(null);
...
$.TestIrv__testIceCream = function() {
  var ballots, i, voter, voter0, ce, t1, firstRound, firstElimination;
  ballots = $.List_List(null);
  ...
  $.expect(ce.get$ballots(), $.unorderedEquals(ballots), null, null, false);
  t1 = ce.get$rounds();
  firstRound = $.getInterceptor$JSStringJSArray(t1).operator$index$1(t1, 0);
...
$.TestPlurality_testSingleVoteSingleWinner = function() {
  ...
  t1 = election.get$places();
  $.expect($.getInterceptor$JSStringJSArray(t1).get$length(t1), $.equals(1, 100), null, null, false);
  t2 = election.get$places();
  firstPlace = $.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, 0);
  t2 = $.getInterceptor$JSStringJSArray(firstPlace);
  $.expect(t2.get$length(firstPlace), $.equals(1, 100), null, null, false);
  $.expect(t2.operator$index$1(firstPlace, 0), $.equals("candidate 1", 100), null, null, false);
};

$.TestPlurality_testTiedforFirst = function() {
  var voters, i, ballots, voters0, election, t1, t2, firstPlace, thirdPlace;
  voters = $.List_List(null);
  for (i = 0; i < 10; ++i)
  ...
  t2 = election.get$places();
  thirdPlace = $.getInterceptor$JSStringJSArray(t2).operator$index$1(t2, 1);
  $.expect(thirdPlace.get$place(), $.equals(3, 100), null, null, false);
  t2 = $.getInterceptor$JSStringJSArray(thirdPlace);
  $.expect(t2.get$length(thirdPlace), $.equals(1, 100), null, null, false);
  $.expect(t2.operator$index$1(thirdPlace, 0), $.equals("candidate 3", 100), null, null, false);
};
...
(function() {
  ...
  $.dynamicSetMetadata([['Uint8Array', v0_Uint8Array], ['WorkerContext', v10_WorkerContext], ['CSSValueList', 'CSSValueList|WebKitCSSTransformValue|WebKitCSSFilterValue|WebKitCSSMixFunctionValue'], ['IDBCursor', 'IDBCursor|IDBCursorWithValue'], ['IDBRequest', v12_Request], ['AbstractWorker', v9_AbstractWorker], ['ArrayBufferView', [v0_Uint8Array, 'ArrayBufferView|DataView|Float32Array|Float64Array|Int16Array|Int32Array|Int8Array|Uint16Array|Uint32Array'].join('|')], ['Blob', 'Blob|File'], ['CharacterData', v5_CharacterData], ['Document', v6_Document], ['DocumentFragment', v7_DocumentFragment], ['DOMTokenList', 'DOMTokenList|DOMSettableTokenList'], ['HTMLMediaElement', v2_MediaElement], ['SVGTextPositioningElement', v1_TextPositioningElement], ['SVGElement', v3_SvgElement], ['Element', v4_Element], ['Entry', 'Entry|DirectoryEntry|FileEntry'], ['EntrySync', 'EntrySync|DirectoryEntrySync|FileEntrySync'], ['Node', v8_Node], ['MediaStream', v11_MediaStream], ['AudioContext', v13_AudioContext], ['EventTarget', [v8_Node, v9_AbstractWorker, v10_WorkerContext, v11_MediaStream, v12_Request, v13_AudioContext, 'EventTarget|DOMApplicationCache|BatteryManager|EventSource|FileReader|FileWriter|XMLHttpRequest|XMLHttpRequestUpload|MediaController|MediaSource|MediaStreamTrack|MediaStreamTrackList|MessagePort|Notification|Performance|RTCDataChannel|RTCPeerConnection|SourceBufferList|SpeechRecognition|TextTrack|TextTrackCue|TextTrackList|WebKitNamedFlow|WebSocket|DOMWindow|IDBDatabase|IDBTransaction|SVGElementInstance'].join('|')], ['AudioParam', 'AudioParam|AudioGain'], ['HTMLCollection', 'HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection'], ['MouseEvent', 'MouseEvent|WheelEvent'], ['NodeList', 'NodeList|RadioNodeList']]);
})();
