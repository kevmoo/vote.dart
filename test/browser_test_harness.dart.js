...
$$.TestRankedBallot_run_anon = {
 ...
 call$0: function() {
  ...
  $.test("2 candidates is cool", new $.TestRankedBallot_run__anon4("voter2", "candidate 2", "candidate 1"));
}
};
...
$$.TestRankedBallot_run__anon2 = {"": ["v2_7", "c1_6"],
 "super": "Closure",
 call$0: function() {
  $.expect(new $.TestRankedBallot_run___anon(this.v2_7, this.c1_6), $.CTC12, null, null, false);
}
};

$$.TestRankedBallot_run___anon = {"": ["v2_9", "c1_8"],
 "super": "Closure",
 call$0: function() {
  var t1, t2;
  t1 = this.v2_9;
...
$$.TestRankedBallot_run__anon3 = {"": ["v2_11", "c1_10"],
 "super": "Closure",
 call$0: function() {
  $.RankedBallot_RankedBallot(this.v2_11, [this.c1_10]);
}
};

$$.TestRankedBallot_run__anon4 = {"": ["v2_14", "c2_13", "c1_12"],
 "super": "Closure",
 call$0: function() {
  $.RankedBallot_RankedBallot(this.v2_14, [this.c1_12, this.c2_13]);
}
};
...
$.IrvRound__getEliminatedCandidates = function(places) {
  ...
  if ($.eqB($.getInterceptor(t1).get$length(t1), 1) && $.geB($.index(places, 0).get$voteCount(), majorityCount))
    return [];
  t1 = $.index(places, $.sub($.getInterceptor(places).get$length(places), 1));
...
$.TestPlurality_testSingleVoteSingleWinner = function() {
  ...
  voters = ["Bad Voter"];
  election = $.PluralityElection_PluralityElection($.List_List$from($.getInterceptor(voters).map$1(voters, new $.TestPlurality_testSingleVoteSingleWinner_anon("candidate 1"))));
...
$.TestPlurality_testPluralityElectionHatesDoubleVotes = function() {
  ...
  $.expect(new $.TestPlurality_testPluralityElectionHatesDoubleVotes_anon($.List_List$from($.getInterceptor(voters).map$1(voters, new $.TestPlurality_testPluralityElectionHatesDoubleVotes_anon0("candidate 1")))), $.CTC10, null, null, false);
};
...
$.CTC41 = new Isolate.$isolateProperties.Creates("String|ArrayBuffer|Null");
...
$.CTC47 = new Isolate.$isolateProperties.Creates("Null");
